...
struct  CLIPPING_MODE_t3226096284 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CLIPPING_MODE_t3226096284, ___value___1)); }
