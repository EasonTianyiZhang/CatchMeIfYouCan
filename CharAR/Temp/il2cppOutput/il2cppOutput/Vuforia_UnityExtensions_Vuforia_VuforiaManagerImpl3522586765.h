...
public:
	inline static int32_t get_offset_of_TrackableId_0() { return static_cast<int32_t>(offsetof(IdPair_t3522586765, ___TrackableId_0)); }
	...
	inline static int32_t get_offset_of_ResultId_1() { return static_cast<int32_t>(offsetof(IdPair_t3522586765, ___ResultId_1)); }
...
struct IdPair_t3522586765_marshaled_pinvoke
{
	int32_t ___TrackableId_0;
	int32_t ___ResultId_1;
};
// Native definition for marshalling of: Vuforia.VuforiaManagerImpl/IdPair
struct IdPair_t3522586765_marshaled_com
{
	int32_t ___TrackableId_0;
	int32_t ___ResultId_1;
};
